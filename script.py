...
def main():
    ...
    click_center_screen(num_clicks=11, bias=100)
...
def start_task():
    ...
    if not running:
        running = True
        threading.Thread(target=automation_task, daemon=True).start()
